...
.
├─ CardioSense.ipynb     # full pipeline (train/eval/plots)
├─ data/                 # local data (not tracked); put ECG5000 here
├─ figs/                 # figures used in README/report
├─ results/              # outputs generated by the notebook
├─ .gitignore
├─ requirements.txt
└─ environment.yml
